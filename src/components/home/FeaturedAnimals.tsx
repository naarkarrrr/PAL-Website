      ...
      <div className="container mx-auto px-4">
        ...
        {!isLoading && (!featuredAnimals || featuredAnimals.length === 0) && (
            <div className="text-center bg-card border border-dashed rounded-xl p-8">
                ...
                <p className="text-muted-foreground max-w-lg mx-auto">Please check back soon to meet some amazing animals looking for their forever homes. New profiles are added regularly!</p>
            </div>
        )}
