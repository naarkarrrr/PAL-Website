            ...
            <div className="bg-card p-8 rounded-lg border shadow-sm">
                ...
                <div className="bg-primary/10 border-l-4 border-primary text-primary p-4 rounded-md">
                    <p className="font-semibold">
                        As your donation is a voluntary and irrevocable gift to support our charitable mission, we operate a strict <strong className="font-bold">no-refund policy</strong>. Once a donation is made, it is immediately put to use to cover our operational costs. Please be sure of the amount you are donating before you proceed.
                    </p>
                </div>
            </div>
